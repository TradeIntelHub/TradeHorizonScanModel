...
Country_codes = Country_codes.drop_duplicates(subset=['ctyCode'])
...
for year in range(2013, 2024):
    ...
    Alberta = pd.merge(Alberta, Country_codes[['UNComTradeCtyId', 'ctyCode']], how='left', left_on='Country', right_on='ctyCode')
